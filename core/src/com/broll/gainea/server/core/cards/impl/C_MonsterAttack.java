...
public class C_MonsterAttack extends AbstractCard {
    public C_MonsterAttack() {
        super(37, "Ogerangriff", "Wählt eine feindliche Truppe und ruft einen wilden Kriegsoger (4/4) herbei der diese angreift.");
        setDrawChance(0.5f);
    }
    ...
    public void play() {
        ...
        Location target = selectHandler.selectLocation("Wählt die feindliche Truppe", PlayerUtils.getHostileLocations(game, owner));
