...
import static com.broll.gainea.server.core.map.impl.GaineaMap.Areas.DUNKLESMEER;
import static com.broll.gainea.server.core.map.impl.GaineaMap.Areas.FELSENWUESTE;
import static com.broll.gainea.server.core.map.impl.GaineaMap.Areas.FELSWALD;
import static com.broll.gainea.server.core.map.impl.GaineaMap.Areas.GROSSES_FELSGEBIRGE;
import static com.broll.gainea.server.core.map.impl.GaineaMap.Areas.GROSSEWUESTE;
import static com.broll.gainea.server.core.map.impl.GaineaMap.Areas.GROSSE_STEPPE;
import static com.broll.gainea.server.core.map.impl.GaineaMap.Areas.GRUENLAND;
import static com.broll.gainea.server.core.map.impl.GaineaMap.Areas.HIENGLAND;
import static com.broll.gainea.server.core.map.impl.GaineaMap.Areas.KIESSTRAND;
import static com.broll.gainea.server.core.map.impl.GaineaMap.Areas.KORBERG;
import static com.broll.gainea.server.core.map.impl.GaineaMap.Areas.KUESTENGEBIET;
import static com.broll.gainea.server.core.map.impl.GaineaMap.Areas.LANDSTRAND;
import static com.broll.gainea.server.core.map.impl.GaineaMap.Areas.MANMAWUESTE;
import static com.broll.gainea.server.core.map.impl.GaineaMap.Areas.MISTRAWUESTE;
import static com.broll.gainea.server.core.map.impl.GaineaMap.Areas.MITSUMA_SEE;
import static com.broll.gainea.server.core.map.impl.GaineaMap.Areas.MOORKUESTE;
import static com.broll.gainea.server.core.map.impl.GaineaMap.Areas.MOORTEICH;
import static com.broll.gainea.server.core.map.impl.GaineaMap.Areas.MOORWUESTE;
import static com.broll.gainea.server.core.map.impl.GaineaMap.Areas.TOTEMGEBIRGE;
import static com.broll.gainea.server.core.map.impl.GaineaMap.Areas.UFERLAND;
import static com.broll.gainea.server.core.map.impl.GaineaMap.Areas.VULKANBERG;
import static com.broll.gainea.server.core.map.impl.GaineaMap.Areas.WEIDESTEPPE;
import static com.broll.gainea.server.core.map.impl.GaineaMap.Areas.XOMDELTA;
import static com.broll.gainea.server.core.map.impl.GaineaMap.Areas.ZWINGSEE;
import static com.broll.gainea.server.core.map.impl.GaineaMap.Continents.GAINEA;
import static com.broll.gainea.server.core.map.impl.GaineaMap.Continents.ZUBA;
import static com.broll.gainea.server.core.map.impl.GaineaMap.Islands.MISTRAINSEL;
import static com.broll.gainea.server.core.map.impl.GaineaMap.Islands.TOTEMINSEL;
...
public class GaineaMap extends ExpansionFactory {
    ...
    public enum Areas implements AreaID {
        KUESTENGEBIET, FELSWALD, FELSENWUESTE, GRUENLAND, XOMDELTA, WEIDESTEPPE, GROSSEWUESTE, DUNKLESMEER,
        KIESSTRAND, HIENGLAND, ZWINGSEE, KORBERG, MOORKUESTE, MOOR,
        MOORWUESTE, MOORTEICH, GROSSES_FELSGEBIRGE, UFERLAND, LANDSTRAND, MANMAWUESTE, GROSSE_STEPPE,
        MITSUMA_SEE, VULKANINSEL, VULKANBERG, TOTEMGEBIRGE, MISTRAWUESTE
    }
