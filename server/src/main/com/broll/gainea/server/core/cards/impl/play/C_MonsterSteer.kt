...
class C_MonsterSteer : Card(
    72,
    DISRUPTION,
    "Monsterköder",
    "Wählt ein Monster und bewegt es um ein Feld weiter, mögliche Ziele werden dabei angegriffen."
) {
    ...
    override fun play() {
        ...
        val target = selectHandler.selectLocation(
            "Wähle das Ziel (Einheiten werden angegriffen)",
