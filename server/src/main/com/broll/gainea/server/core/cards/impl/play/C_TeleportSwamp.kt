...
class C_TeleportSwamp : TeleportCard(
    45,
    "Sumpferkundung",
    "Bewegt eine Truppe zu einem beliebigen Sumpf auf der gleichen Karte"
) {
    override fun getTeleportTargets(from: Location) =
        from.container.expansion.allAreas.filter { it.type == BOG }
