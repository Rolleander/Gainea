...
class RequiredActionContext<T : NT_Action>
(val actionContext: ActionContext<T>, val text: String, val messageForOtherPlayer: Any? = null)
    : ActionContext<T>(actionContext.action) {
