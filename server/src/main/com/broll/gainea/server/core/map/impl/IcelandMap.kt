...
class IcelandMap : ExpansionFactory(ExpansionType.ICELANDS, "expansion_1.png") {
    ...
    private fun seism() {
        continent(
            Continents.SEISM, "Seism", listOf(
                ...
                area(Areas.WEISSESGEBIET, "Weißes Gebiet", AreaType.SNOW, 58.6f, 47.3f)
            )
        )
    ...
    private fun ships() {
        ...
        ships(
            Areas.SCHNEEFELDER,
            Areas.KAELTESTEPPE,
            floatArrayOf(44.7f, 47f),
            floatArrayOf(31.3f, 27.2f)
        )
        ...
        ships(
            Areas.TOTEM,
            Areas.SCHNEEFELDER,
            floatArrayOf(31.8f, 35.5f),
            floatArrayOf(50.7f, 49.1f)
        )
        ...
        ships(
            Areas.PACKEIS,
            Areas.GRUENESMEER,
            floatArrayOf(37.3f, 33.6f),
            floatArrayOf(74.3f, 73.4f)
        )
    ...
    override fun connectWithExpansion(expansion: ExpansionFactory) {
        if (expansion is GaineaMap) {
            ships(
                Areas.GRASSUMPF,
                GaineaMap.Areas.UFERLAND,
                floatArrayOf(84.2f, 92.1f),
                floatArrayOf(45.1f, 48.2f)
            )
            ships(
                Areas.FREILAND,
                GaineaMap.Areas.GROSSEWUESTE,
                floatArrayOf(76f, 83f, 91f, 100f),
                floatArrayOf(79f, 79.5f, 81f, 83f)
            )
        }
        if (expansion is BoglandMap) {
            ships(
                Areas.EISLAND,
                BoglandMap.Areas.SCHRECKENHORN,
                floatArrayOf(89.4f, 92.3f, 95.5f),
                floatArrayOf(29.9f, 24.9f, 20f)
            )
        }
    }
}
