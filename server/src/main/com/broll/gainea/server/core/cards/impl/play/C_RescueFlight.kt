...
class C_RescueFlight : Card(
    73,
    MOVEMENT,
    "Luftrettung",
    "Bewegt eine eurer Einheiten auf ein beliebiges freies Feld"
) {
    init {
        drawChance = 0.3f
    }
    ...
    override fun play() {
        ...
        val target =
            selectHandler.selectLocation("Wohin bewegen?", game.map.allLocations.filter { it.free })
