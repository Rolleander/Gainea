...
class C_Tunnel : Card(
    ...
    MOVEMENT,
    "Tunnelgräber",
    "Bewegt eine Truppe auf ein beliebiges freies Gebiet, welches maximal " + DISTANCE + " Felder entfernt ist"
) {
    ...
    override fun play() {
        val from =
            selectHandler.selectLocation("Wählt eine Truppe", owner.controlledLocations.toList())
