...
class C_SeaStorm : DirectlyPlayedCard(
    68,
    CHAOS,
    "Enterchaos",
    "Alle Schiffe wechseln ihre Besetzer zufällig mit anderen Schiffen der gleichen Karte"
) {
    override fun play() {
        game.map.expansions.forEach { expansion ->
            ...
            shipWithUnits.forEach { units ->
                val newShip: Location =
                    RandomUtils.pickRandom(expansion.allShips.filter { it.free })
